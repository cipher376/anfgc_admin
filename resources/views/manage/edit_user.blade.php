...
@endif
                ...
                {{ csrf_field() }}
                    ...
                    <div class="intro-y col-span-12 sm:col-span-6">
                            ...
                            <input name="name" type="text" class="input w-full border flex-1" placeholder="Full name" value="{{ $user->name }}">
                            </div>
                        ...
                        <div class="intro-y col-span-12 sm:col-span-6">
                            ...
                            <input name="email" type="email" class="input w-full border flex-1" value="{{ $user->email }}" placeholder="example@gmail.com"  required autofocus>
                        </div>
                        <div class="intro-y col-span-12 sm:col-span-6">
                            <div class="mb-2">Password</div>
                            <input name="password" type="text" class="input w-full border flex-1" placeholder="password" value="{{ $user->password }}">
                         </div>
                        ...
                        <div class="intro-y col-span-12 sm:col-span-6">
                            ...
                            <option value="{{$user->role}}"><?php if($user->role=="manage"){ echo"Super Admin"; }else if($user->role=="manage-sub"){ echo"Admin";} ?></option>
