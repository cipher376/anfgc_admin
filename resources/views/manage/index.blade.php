                                    ...
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            <div class="flex">
                                                ...
                                                <div class="ml-auto">
                                                    <div class="report-box__indicator bg-theme-9 tooltip cursor-pointer" title="Total Sermon Upload">  <?php  echo $sermons->count(); ?> Uploads<i data-feather="chevron-up" class="w-4 h-4"></i> </div>
                                                </div>
                                            </div>
                                            <div class="text-3xl font-bold leading-8 mt-6"><?php  echo $sermons->count(); ?></div>
                                ...
                                <div class="mt-5 intro-x">
                                    <div class="slick-carousel box zoom-in" id="important-notes">
                                        ...
                                        <div class="p-5">
                                            ...
                                            <div class="text-gray-600 text-justify mt-1">{{ strip_tags(htmlspecialchars_decode(substr($message->sermon, 0,170) ))}}</div>
                                            <div class="font-medium flex mt-5">
                                                <a href="/manage/sermons/view/{{$message->id}}" class="button button--sm bg-gray-200 text-gray-600">View Sermon</a>
