            ...
            @foreach($countries as $country)
             ...
             @endforeach
                     ...
                     <div class="intro-y col-span-12 sm:col-span-6">
                         ...
                         <input name="location" type="text" class="input w-full border flex-1" placeholder="Branch location" value="{{ ucfirst($church->location) }}">
                     ...
                     <div class="intro-y col-span-12 sm:col-span-12">
                         <div class="mb-2">Pastor In-charge </div>
                         <input name="pastor" type="text" class="input w-full border flex-1" placeholder="Location" value="{{ ucfirst($church->pastor) }}">
                     </div>
                     ...
                     <div class="intro-y col-span-12 sm:col-span-6">
                         ...
                         <input name="phone" type="text" class="input w-full border flex-1" placeholder="Phone" value="{{ ucfirst($church->phone) }}">
                       
                     </div>

                     <div class="intro-y col-span-12 sm:col-span-6">
                         <div class="mb-2">Email</div>
                         <input name="email" type="text" class="input w-full border flex-1" placeholder="email" value="{{ ucfirst($church->email) }}">
                         </div>
