...
<div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Administration</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">New Video</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
             ...
             <div class="px-5 sm:px-20 mt-10 pt-3 border-gray-200">
                 ...
                 <div class="grid grid-cols-12 gap-4 row-gap-5 mt-5">
                     ...
                     <div class="intro-y col-span-12 flex items-center justify-center sm:justify-end mt-5">
                         ...
                         <button class="button w-40 justify-center block bg-theme-1 text-white ml-2">Save Video</button>
                     </div>
                 </div>
