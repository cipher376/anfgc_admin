                    ...
                    <tr class="hover:bg-gray-200">
                        <td class=""> <input type="checkbox" name="sermon[]" class="input border mr-2" id="vertical-checkbox-chris-evans" value="{{$sermon->id}}"></td>
                                ...
                                <td class="border-b whitespace-no-wrap">
                                    ...
                                    <?php }else if(Auth::user()->role=="manage"){?>

                                        <a class="flex items-center mr-3" href="./sermons/edit/{{ $sermon->id}}"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
                                        <a class="flex items-center text-theme-6" id="deleteUser{{ $sermon->id}}" data-userid="{{$sermon->id}}" href="javascript:void(0)" onclick="showAlert({{ $sermon->id}});" >
...
function senddel(){
    ...
    window.location="/manage/sermons/delete/"+$('#app_id').val();
