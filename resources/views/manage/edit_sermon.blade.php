...
@foreach($sermons as $sermon)
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Administration</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Edit Sermon</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i>{{ strip_tags(htmlspecialchars_decode(substr($sermon->topic, 0,70) ))}}...</div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                ...
                <div class="px-5 sm:px-20 mt-10 pt-3 border-gray-200">
                  ...
                  <form   method="POST" action="{{ route('sermons.update',$sermon->id) }}" enctype="multipart/form-data">  
                  {{ method_field("PUT")}}
...
@endif
                  ...
                  {{ csrf_field() }} 
                    ...
                    <div class="intro-y col-span-12 sm:col-span-6">
                            ...
                            <input name="topic" type="text" class="input w-full border flex-1" placeholder="Sermon Topic" value="{{ ucfirst($sermon->topic) }}">
                            </div>


                        <div class="intro-y col-span-12 sm:col-span-6">
                            <div class="mb-2">Author</div>
                            <input name="author" type="text" class="input w-full border flex-1" placeholder="Name of minister" value="{{ ucwords($sermon->author) }}">
                           
                        </div>
                        <div class="intro-y col-span-12 sm:col-span-12">
                        <div class="mb-2">Sermon</div>
                        <textarea data-feature="basic" class="summernote" name="sermon"> {{ strip_tags(htmlspecialchars_decode($sermon->sermon)) }}</textarea> 
 
                        </div>

                        <div class="intro-y col-span-12 sm:col-span-12">
                            
                        <div class="mb-6" ><b>Uploaded File:</b><span style="color:blue"> {{ ucwords($sermon->filename) }}</span></div>
